...
`).join(""),Se=u.map((e,t)=>{const a=r(`history.gallery.${t}.title`);return`
    <li>
      <button
  ...
  `}).join(""),Fe=r("history.interview").map((e,t)=>`
  <li>
    <details>
      <summary>
...
`).join(""),A={...u[0],...r("history.gallery.0")};Z.innerHTML=`
  ...
  <header class="site-header" data-header>
    <div class="container header-inner">
      ...
      >
        <img
          src="${o("/F1garage/images/logo-white.png")}"
          alt="${r("a11y.logoAlt")}"
  ...
  <main id="main">
    <section class="hero" id="home" aria-labelledby="hero-title">
      <picture class="hero__media">
        <source media="(max-width: 760px)" srcset="${o("/F1garage/images/generated/hero-premium-auto-service-mobile.webp")}" type="image/webp" />
        <img
          class="hero__image"
          src="${o("/F1garage/images/generated/hero-premium-auto-service.webp")}"
          alt="${r("hero.imageAlt")}"
      ...
      <div class="container hero__content">
        ...
        <h1 id="hero-title">
          ...
          <img
            ...
            src="${o("/F1garage/images/Auto-batumi-F1-2.png")}"
    ...
    <section class="manifesto angled-section" id="about" aria-labelledby="about-title">
      <img
        ...
        src="${o("/F1garage/images/manifesto-wheel.webp")}"
        alt=""
        aria-hidden="true"
        width="1200"
        height="1200"
    ...
    <section class="prices angled-section angled-section--red" id="prices" aria-labelledby="prices-title">
      <img
        ...
        src="${o("/F1garage/images/prices-gloves-cutout.webp")}"
        alt=""
        aria-hidden="true"
        width="1254"
        height="1254"
                  ...
                  <div class="story-carousel__stage">
                    ...
                    <article class="story-copy" aria-labelledby="story-title">
                      ...
                      <div class="story-controls">
                        ...
                        <p class="story-counter"><strong data-story-current>01</strong><span aria-hidden="true"> / </span><span>${String(u.length).padStart(2,"0")}</span></p>
                        <button
                          type="button"
                          data-story-next
                      ...
                      <div
                        ...
                        aria-valuemin="1"
                        aria-valuemax="${u.length}"
                        aria-valuenow="1"
                        aria-valuetext="${r("history.photoCount",{current:1,total:u.length})}"
                      ><span></span></div>
                    </article>
                  </div>
...
`;const G=document.querySelector(".menu-toggle"),ee=document.querySelector(".mobile-menu");function M(e){G.setAttribute("aria-expanded",String(e)),G.setAttribute("aria-label",r(e?"a11y.closeMenu":"a11y.openMenu")),ee.hidden=!e,document.body.classList.toggle("menu-open",e)}G.addEventListener("click",()=>M(G.getAttribute("aria-expanded")!=="true"));ee.querySelectorAll("a").forEach(e=>e.addEventListener("click",()=>M(!1)));const x=[...document.querySelectorAll("[data-language-switcher]")].map(e=>({root:e,trigger:e.querySelector("[data-language-trigger]"),menu:e.querySelector('[role="listbox"]'),options:[...e.querySelectorAll("[data-language-option]")],status:e.querySelector("[data-language-status]")}));function E(e,{restoreFocus:t=!1}={}){e.trigger.setAttribute("aria-expanded","false"),e.menu.hidden=!0,t&&e.trigger.focus({preventScroll:!0})}function Re(e=null){x.forEach(t=>{t!==e&&E(t)})}function Y(e,{focusOption:t=!0}={}){Re(e),e.trigger.setAttribute("aria-expanded","true"),e.menu.hidden=!1,t&&(e.options.find(i=>i.getAttribute("aria-selected")==="true")??e.options[0])?.focus({preventScroll:!0})}function O({announce:e=!1}={}){const t=W();x.forEach(a=>{a.root.querySelector("[data-language-current]").textContent=t.toUpperCase(),a.options.forEach(i=>{i.setAttribute("aria-selected",String(i.dataset.languageOption===t))}),e&&(a.status.textContent="",requestAnimationFrame(()=>{a.status.textContent=r("language.changed",{language:r(`language.names.${t}`)})}))})}function ke(e,t){const a=me(t);E(e,{restoreFocus:!0}),a||O({announce:!0})}x.forEach(e=>{e.trigger.addEventListener("click",()=>{e.trigger.getAttribute("aria-expanded")==="true"?E(e):Y(e,{focusOption:!1})}),e.trigger.addEventListener("keydown",t=>{if(!["ArrowDown","ArrowUp"].includes(t.key))return;t.preventDefault(),Y(e);const a=Math.max(0,e.options.findIndex(s=>s.getAttribute("aria-selected")==="true")),i=t.key==="ArrowUp"?(a-1+e.options.length)%e.options.length:a;e.options[i]?.focus({preventScroll:!0})}),e.options.forEach((t,a)=>{t.addEventListener("click",()=>ke(e,t.dataset.languageOption)),t.addEventListener("keydown",i=>{const s={ArrowDown:()=>e.options[(a+1)%e.options.length],ArrowUp:()=>e.options[(a-1+e.options.length)%e.options.length],Home:()=>e.options[0],End:()=>e.options.at(-1)};if(i.key==="Escape"){i.preventDefault(),i.stopPropagation(),E(e,{restoreFocus:!0});return}s[i.key]&&(i.preventDefault(),s[i.key]()?.focus({preventScroll:!0}))})})});document.addEventListener("pointerdown",e=>{x.forEach(t=>{t.root.contains(e.target)||E(t)})});document.addEventListener("keydown",e=>{if(e.key!=="Escape")return;const t=x.find(a=>a.trigger.getAttribute("aria-expanded")==="true");if(t){E(t,{restoreFocus:!0});return}G.getAttribute("aria-expanded")==="true"&&M(!1)});const $=document.querySelector("[data-story-slider]"),te=$.querySelector("[data-story-slider-viewport]"),v=[...$.querySelectorAll("[role=tab]")],Le=[...$.querySelectorAll("[data-story-view-target]")],N=[...$.querySelectorAll("[role=tabpanel]")];function R(){const e=N.find(t=>t.id===($.dataset.storyView==="interview"?"story-interview-panel":"story-archive-panel"));e&&(te.style.height=`${e.offsetHeight}px`)}function B(e,{focus:t=!0}={}){const a=e==="interview"?"interview":"archive",i=a==="interview"?"story-interview-panel":"story-archive-panel";$.dataset.storyView=a,te.scrollLeft=0,v.forEach(s=>s.setAttribute("aria-selected",String(s.dataset.storyViewTarget===a))),N.forEach(s=>{const n=s.id!==i;s.setAttribute("aria-hidden",String(n)),s.toggleAttribute("inert",n),"inert"in s&&(s.inert=n)}),requestAnimationFrame(R),t&&v.find(s=>s.dataset.storyViewTarget===a)?.focus({preventScroll:!0})}Le.forEach(e=>{e.addEventListener("click",()=>B(e.dataset.storyViewTarget))});v.forEach((e,t)=>{e.addEventListener("keydown",a=>{if(!["ArrowLeft","ArrowRight"].includes(a.key))return;a.preventDefault();const i=a.key==="ArrowRight"?(t+1)%v.length:(t-1+v.length)%v.length,s=v[i];B(s.dataset.storyViewTarget)})});window.location.hash==="#owner-blog"&&window.history.replaceState(window.history.state,"",`${window.location.pathname}${window.location.search}`);B("archive",{focus:!1});window.addEventListener("load",R,{once:!0});window.addEventListener("resize",R);if("ResizeObserver"in window){const e=new ResizeObserver(R);N.forEach(t=>e.observe(t))}const d=document.querySelector(".story-carousel"),S=d.querySelector(".story-visual");let k=d.querySelector(".story-visual__image");const X=d.querySelector(".story-visual__backdrop"),ae=d.querySelector("[data-story-chapter]"),ie=d.querySelector("[data-story-title]"),re=d.querySelector("[data-story-caption]"),_e=d.querySelector("[data-story-current]"),_=d.querySelector(".story-progress"),qe=d.querySelector("[data-story-status]"),K=d.querySelector(".story-thumbnails"),C=[...d.querySelectorAll("[data-story-index]")],T=window.matchMedia("(prefers-reduced-motion: reduce)");let p=0,L=0,w=null;function se(e){return{...u[e],...r(`history.gallery.${e}`)}}function Ce(e){return(e+u.length)%u.length}function Me(e){L+=1;const t=L;if(T.matches){k.src=e.src,k.alt=e.alt,X.src=e.src;return}const a=k,i=a.cloneNode();i.className="story-visual__image story-visual__image--incoming",i.src=e.src,i.alt=e.alt,S.append(i);const s=()=>{if(t!==L){i.remove();return}X.src=e.src,a.classList.add("is-leaving"),requestAnimationFrame(()=>{requestAnimationFrame(()=>i.classList.add("is-visible"))});let n=!1;const l=()=>{if(!n){if(n=!0,t!==L){i.remove();return}a.remove(),i.classList.remove("story-visual__image--incoming","is-visible"),k=i}};i.addEventListener("transitionend",l,{once:!0}),window.setTimeout(l,700)};i.complete?s():(i.addEventListener("load",s,{once:!0}),i.addEventListener("error",s,{once:!0}))}function ne(){const e=se(p),t=p+1;S.querySelectorAll(".story-visual__image").forEach(a=>{a.alt=e.alt}),ae.textContent=g(e.chapter),ie.textContent=g(e.title),re.textContent=g(e.caption),_.setAttribute("aria-valuetext",r("history.photoCount",{current:t,total:u.length})),C.forEach((a,i)=>{a.setAttribute("aria-label",r("history.showPhoto",{current:i+1,title:r(`history.gallery.${i}.title`)}))})}function b(e,{announce:t=!0}={}){p=Ce(e);const a=se(p),i=p+1,s=C[p];Me(a),ae.textContent=g(a.chapter),ie.textContent=g(a.title),re.textContent=g(a.caption),_e.textContent=String(i).padStart(2,"0"),_.style.setProperty("--story-progress",`${i/u.length*100}%`),_.setAttribute("aria-valuenow",String(i)),_.setAttribute("aria-valuetext",r("history.photoCount",{current:i,total:u.length})),C.forEach((l,h)=>{l.setAttribute("aria-current",String(h===p))});const n=s.offsetLeft-(K.clientWidth-s.offsetWidth)/2;K.scrollTo({left:n,behavior:T.matches?"auto":"smooth"}),t&&(qe.textContent=r("history.announcement",{current:i,total:u.length,chapter:a.chapter,title:a.title}))}d.querySelector("[data-story-prev]").addEventListener("click",()=>b(p-1));d.querySelector("[data-story-next]").addEventListener("click",()=>b(p+1));C.forEach(e=>{e.addEventListener("click",()=>b(Number(e.dataset.storyIndex)))});d.addEventListener("keydown",e=>{const t={ArrowLeft:()=>b(p-1),ArrowRight:()=>b(p+1),Home:()=>b(0),End:()=>b(u.length-1)};t[e.key]&&(e.preventDefault(),t[e.key]())});S.addEventListener("pointerdown",e=>{e.isPrimary&&(w={x:e.clientX,y:e.clientY})});S.addEventListener("pointerup",e=>{if(!w||!e.isPrimary)return;const t=e.clientX-w.x,a=e.clientY-w.y;w=null,!(Math.abs(t)<45||Math.abs(t)<=Math.abs(a))&&b(p+(t<0?1:-1))});S.addEventListener("pointercancel",()=>{w=null});S.addEventListener("dragstart",e=>e.preventDefault());const Te=[...document.querySelectorAll(".owner-interview details")];async function Pe(e,t){if(e.dataset.animating==="true")return;const a=e.querySelector(".owner-interview__answer");if(!a)return;if(T.matches||typeof a.animate!="function"){e.open=t;return}e.dataset.animating="true",t&&(e.open=!0);const i=t?0:a.getBoundingClientRect().height,s=t?a.scrollHeight:0,n=a.animate([{height:`${i}px`,opacity:t?0:1,transform:t?"translateY(-0.45rem)":"translateY(0)"},{height:`${s}px`,opacity:t?1:0,transform:t?"translateY(0)":"translateY(-0.45rem)"}],{duration:t?440:340,easing:"cubic-bezier(.22, .61, .36, 1)",fill:"both"});try{await n.finished}catch{delete e.dataset.animating;return}t||(e.open=!1),n.cancel(),delete e.dataset.animating}Te.forEach(e=>{e.querySelector("summary").addEventListener("click",a=>{a.preventDefault(),Pe(e,!e.open)})});document.addEventListener("languagechange",()=>{ge(Z),M(G.getAttribute("aria-expanded")==="true"),ne(),O({announce:!0}),requestAnimationFrame(R)});Ge();O();ne();if(!T.matches&&"IntersectionObserver"in window){document.documentElement.classList.add("has-motion");const e=new IntersectionObserver(t=>{t.forEach(a=>{a.isIntersecting&&(a.target.classList.add("is-visible"),e.unobserve(a.target))})},{rootMargin:"0px 0px -8%",threshold:.08});document.querySelectorAll(".reveal, .wheel-reveal").forEach(t=>e.observe(t))}
